10 MODE8:DIM:GOSUB900:c$=CHR$(5):DEFCHR$(252)="123E020000":DEFCHR$(253)="2E2A3A0000":DEFCHR$(254)="A2A49C92A2":t$="N(ü,Ž’),N(ý,Ž’) a<ü-ý<b"
...
130 PRINTc$;a;"< ü-ý <";b;:a$=INPUT$(1,@):GOTO45
